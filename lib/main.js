...
let { resolveURI,load,evaluate,Loader, Require, unload } = require('toolkit/loader');
...
const {switchtab} = require("ui-utils");
...
var main = function(options,callback) {
    ...
    require('flight-control').revive(); // restart any old ones
    let flightcontroller = require('flight-control').FlightController();
