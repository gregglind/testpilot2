...
let {validateOptions} = require('sdk/deprecated/api-utils');
...
/** log IFF `prefs.tplog` is set.
  *
  * @return undefined
  * @name tplog
  */
let tplog = exports.tplog = function(){
    myprefs.tplog  && console.log.apply(null, arguments);
}

let ohno = exports.ohno = function(){
    myprefs.tplog  && console.error.apply(null, arguments);
}
...
/**
  */
var schedule = exports.schedule = function (timeout, callbackfunction) {
    return {
        start: function () {
            return timers.setTimeout(callbackfunction, timeout)
        }
    };
};
